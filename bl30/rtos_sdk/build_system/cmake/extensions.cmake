...
function(generate_module_info_output TARGET)
  ...
  if($ENV{COMPILER} STREQUAL "clang+llvm")
    add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND COMPILER=$ENV{COMPILER} python ${PROJECT_SOURCE_DIR}/scripts/map_analyzer_clang_llvm.py --combine ${map_file_path} > $<TARGET_FILE_DIR:${TARGET}>/$ENV{KERNEL}_module_info.txt)
  else()
    add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND COMPILER=$ENV{COMPILER} python ${PROJECT_SOURCE_DIR}/scripts/map_analyzer_gcc_xcc.py --combine ${map_file_path} > $<TARGET_FILE_DIR:${TARGET}>/$ENV{KERNEL}_module_info.txt)
  endif()
endfunction()
