...
static void power_off_at_24M(unsigned int suspend_from)
{
	...
	if (suspend_from == SYS_POWEROFF){
		/* TEST_N low to turn off VCC3V3 */
		/* VDDEE VCC3V3 VCC1V8 EMMC CVBS RED_LED */
